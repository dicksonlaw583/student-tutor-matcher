...
describe OfferingsController do
  ...
  before do
    ...
    sign_in @tutor
    @course_offered = FactoryGirl.create(:course)
    @course_not_yet_offered = FactoryGirl.create(:course)
    @offering_current = @tutor.offer_course(@course_offered, 25)
  end
  ...
  def valid_new_attributes
    {
      :price => 35,
      :course_id => @course_not_yet_offered.id
    }
  end
  ...
  describe "GET index" do
    it "assigns all offerings as @offerings" do
      get :index
      assigns(:offerings).should eq([@offering_current])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Offering" do
        expect {
          post :create, {:offering => valid_new_attributes}
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested offering" do
        ...
        Offering.any_instance.should_receive(:update_attributes).with({'these' => 'params', "user_id" => @tutor.id})
        put :update, {:id => offering.to_param, :offering => {'these' => 'params'}}
      end

      it "assigns the requested offering as @offering" do
        offering = FactoryGirl.create(:offering)
        put :update, {:id => offering.to_param, :offering => valid_new_attributes}
        assigns(:offering).should eq(offering)
      end
